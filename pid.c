...
void PID_init(void){
    ...
    pid1_v.integral=0.0;    pid1_v.Kp=0.4;
    ...
    pid2_v.integral=0.0;    pid2_v.Kp=0.4;
    ...
    pid_pos.SetSpeed=15.0; pid_pos.ActualSpeed=0.0;
    pid_pos.err=0.0;      pid_pos.err_last=0.0;
    pid_pos.voltage=0.0;  pid_pos.integral=0.0;
    pid_pos.Kp=1.65;      pid_pos.Ki=0.001;
    pid_pos.Kd=0.003;
}
